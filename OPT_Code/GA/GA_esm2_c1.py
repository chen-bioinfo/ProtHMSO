...
# 使用示例
antimicrobial_peptides = load_antimicrobial_peptides_from_csv('/geniusland/home/wanglijuan/sci_proj/GA_opt/srcdata/case1.csv')
...
# 初始化种群，使用自己的抗菌肽数据集
population = toolbox.population(n=875)  # 种群大小为300
# 用于存储每一代两个目标的适应度信息
max_score1_values = []
avg_score1_values = []
max_score2_values = []
...
data = pd.read_csv('/geniusland/home/wanglijuan/sci_proj/ESM2_opt/src_datasets/case1.csv')
...
df.to_csv('/geniusland/home/wanglijuan/sci_proj/ESM2_opt/AMP_Methods_Compare/case1/GA_esm2/case1_pred.csv', index=False)
df0.to_csv('/geniusland/home/wanglijuan/sci_proj/ESM2_opt/AMP_Methods_Compare/case1/GA_esm2/case1_seq.csv', index=False)
