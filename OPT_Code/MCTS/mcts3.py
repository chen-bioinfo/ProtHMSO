...
if __name__ == '__main__':
    ...
    data = pd.read_csv('/geniusland/home/wanglijuan/sci_proj/GA_opt/srcdata/case3.csv')
    seqs = data['Sequence']
    # rs = []
    # for s in tqdm(seqs):
    #     root = Node(State(s))
    #     best_node = uct_search(root, 5000)
    #     best_sequence = find_highest_scored_sequence(root)
    #     rs.append(best_sequence[0])
    ...
    case1 = pd.read_csv('/geniusland/home/wanglijuan/sci_proj/GA_opt/srcdata/case3.csv')
    ...
    df.to_csv('/geniusland/home/wanglijuan/sci_proj/ESM2_opt/AMP_Methods_Compare/case3/MCTS/pred_1000.csv', index=False)
    df0.to_csv('/geniusland/home/wanglijuan/sci_proj/ESM2_opt/AMP_Methods_Compare/case3/MCTS/seq_1000.csv', index=False)
