...
if __name__ == '__main__':
    ...
    data = pd.read_csv('/geniusland/home/wanglijuan/sci_proj/GA_opt/srcdata/case2.csv')
    seqs = data['Sequence']
    ...
    case1 = pd.read_csv('/geniusland/home/wanglijuan/sci_proj/GA_opt/srcdata/case2.csv')
    ...
    df.to_csv('/geniusland/home/wanglijuan/sci_proj/ESM2_opt/AMP_Methods_Compare/case2/MCTS/pred_1000.csv', index=False)
    df0.to_csv('/geniusland/home/wanglijuan/sci_proj/ESM2_opt/AMP_Methods_Compare/case2/MCTS/seq_1000.csv', index=False)
